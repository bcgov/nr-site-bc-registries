...
export class BCRegistryService {
  constructor(private httpService: HttpService) {
    synopsisTemplate = base64.encode(fs.readFileSync('./frontend//utils/templates/synopsisTemplate.html', 'utf8'));
    detailedPartialTemplate = fs.readFileSync('./frontend/utils/templates/detailedPartialTemplate.html', 'utf8');
