...
@Module({imports: [SrassocsModule, SrdatesModule, SreventsModule, SrevpartsModule, SrlandsModule, SrparrolsModule, SrpinpidsModule, SrprfansModule, SrprfcatsModule, SrprfquesModule, SrprfusesModule, SrprofilsModule, SrsitdocsModule, SrsitparsModule, SrsitesModule],
  controllers: [],
  providers: [CronService, SrassocsService, SrdatesService, SreventsService, SrevpartsService, SrlandsService, SrparrolsService, SrpinpidsService, SrprfansService, SrprfcatsService, SrprfquesService, SrprfusesService, SrprofilsService, SrsitdocsService, SrsitparsService, SrsitesService],})
