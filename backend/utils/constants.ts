...
export const CSV_HEADERS = {
  ...
  SRPROFIL:
    'siteId,dateCompleted,ownerParticipantId,contactParticipantId,completorParticipantId,dateReceived,dateLocalAuthority,dateRegistrar,dateDecision,dateEntered,decisionText,commentString,plannedActivityComment,siteDisclosureComment,govDocumentsComment,localAuthEmail\n',
