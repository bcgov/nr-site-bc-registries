...
export const CSV_HEADERS = {
    ...
    SREVENTS:
        'siteId,eventId,eventType,eventClass,eventDate,ministryContact,noteString,requiredAction\n',
    SREVPART: 'eventId,nameString,roleString\n',
    SRLANDS: 'siteId,landUse,noteString\n',
    SRPARROL: 'participantId,roleString\n',
    SRPINPID:
        'siteId,pin,pid,crownLandsFileNumber,legalDescription,dateNoted\n',
    SRPRFANS: 'siteId,questionId,dateCompleted,answer\n',
    SRPRFCAT:
        'categoryId,sequenceNumber,effectiveDate,expiryDate,questionType,categoryDescription\n',
    SRPRFQUE:
        'questionId,sequenceNumber,categoryId,parentQuestionId,effectiveDate,expiryDate,questionDescription\n',
    ...
    SRSITDOC:
        'siteId,docId,titleString,submissionDate,documentDate,noteString\n',
    SRSITES:
    ...
    SRSITPAR:
        'siteId,participantId,nameString,effectiveDate,endDate,noteString,participantType\n',
};
